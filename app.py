...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql:///authenticate'
...
app.config['MAIL_USERNAME'] = secret_keys["mail_server"][0]
app.config['MAIL_PASSWORD'] = secret_keys["mail_server"][1]
app.config['MAIL_USE_TLS'] = True
app.config['MAIL_USE_SSL'] = False
app.config['MAIL_DEFAULT_SENDER'] = secret_keys['mail_server'][0]
